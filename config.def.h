...
static const char *fonts[]          = { "JetBrainsMono Nerd Font:size=10:style=Bold", "Vazirmatn UI NL:size=10:style=Bold" };
...
static const Rule rules[] = {
	...
	{   "org.mozilla.Thunderbird",      NULL,     NULL,  	        1   << 6,    0,          -1,     0  },
...
static const Key keys[] = {
	...
	{ 0,      XK_End,                    spawn,     SHCMD("playerctl next") },
	{ 0,      XK_Home,                   spawn,     SHCMD("playerctl previous") },
	{ MODKEY, XK_End,                    spawn,     SHCMD("playerctl position 10+") },
	{ MODKEY, XK_Home,                   spawn,     SHCMD("playerctl position 10-") },
	{ 0,      XK_Insert,                 spawn,     SHCMD("playerctl play-pause") },
	{ MODKEY, XK_Insert,                 spawn,     SHCMD("playerctl stop") },
	{ 0,      XK_Page_Up,                spawn,     SHCMD("wpctl set-volume -l 1.5 @DEFAULT_AUDIO_SINK@ 5%+") },
	{ 0,      XK_Page_Down,              spawn,     SHCMD("wpctl set-volume -l 1.5 @DEFAULT_AUDIO_SINK@ 5%-") },
	{ 0,      XK_Pause,                  spawn,     SHCMD("wpctl set-mute @DEFAULT_AUDIO_SINK@ toggle") },
	{ 0,      XK_Scroll_Lock,            spawn,     SHCMD("wpctl set-mute @DEFAULT_AUDIO_SOURCE@ toggle") },
	TAGKEYS(                        XK_1,                      0)
	TAGKEYS(                        XK_2,                      1)
	TAGKEYS(                        XK_3,                      2)
	TAGKEYS(                        XK_4,                      3)
