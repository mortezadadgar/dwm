...
static const char col_gray5[]       = "#83a598"; /* blue */
static const char col_gray6[]       = "#fabd2f"; /* yellow */
static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { col_gray3, col_gray1, col_gray2 },
	[SchemeSel]  = { col_gray1, col_gray6,  col_gray5  },
	[SchemeStatus]  = { col_gray3, col_gray4,  "#000000"  }, // Statusbar right
	[SchemeTagsSel]  = { col_gray6, col_gray4,  "#000000"  }, // Tagbar left selected
