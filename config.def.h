...
static const Key keys[] = {
	...
	{ 0, XF86XK_AudioStop,          spawn,     SHCMD("playerctl -a stop") },
	...
	{ 0,      XK_End,                    spawn,     SHCMD("playerctl -a next") },
	{ 0,      XK_Home,                   spawn,     SHCMD("playerctl -a previous") },
	{ MODKEY, XK_End,                    spawn,     SHCMD("mpc -q seek +5%") },
	{ MODKEY, XK_Home,                   spawn,     SHCMD("mpc -q seek -5%") },
	{ 0,      XK_Insert,                 spawn,     SHCMD("playerctl -a play-pause") },
	{ MODKEY, XK_Insert,                 spawn,     SHCMD("playerctl -a stop") },
